...
public class MainActivity extends AppCompatActivity {
    ...
    public void start(View view) {
        ...
        int numberOfCore = Integer.valueOf(mEtNumberOfCore.getText().toString().trim());
        int threadOfPerCore = Integer.valueOf(mEtThreadOfPerCore.getText().toString().trim());
        long cpuUsage = Long.valueOf(mEtCpuUsage.getText().toString().trim());
        if (numberOfCore < 0) {
